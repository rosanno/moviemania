    ...
    <Link to={`/movie/details/${movie?.id}`} className="mt-4">
      {movie?.poster_path !== null ? (
        <img
          ...
          alt={movie?.title}
          className="w-full md:max-w-[200px] h-[290px] md:max-h-[250px] rounded-md overflow-hidden"
        />
      ) : (
        <div className="w-full md:max-w-[200px] h-[250px] bg-gray-300 rounded-md flex items-center justify-center">
